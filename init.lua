...
do
  ...
  -- <C-h/j/k/l> are handled by vim-tmux-navigator (lua/custom/plugins/tmux-navigator.lua)
  -- which seamlessly crosses into tmux panes at window edges.
...
-- snacks.nvim picker setup, keymaps, LSP picker mappings
-- ============================================================
do
  ...
  vim.api.nvim_create_autocmd('LspAttach', {
    group = vim.api.nvim_create_augroup('kickvim-lsp-attach', { clear = true }),
